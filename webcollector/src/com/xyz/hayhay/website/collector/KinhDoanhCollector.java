...
public class KinhDoanhCollector extends ArticleCollector{
	...
	public String[] collectedUrls() {
		return "http://cafebiz.vn/nhan-vat.chn,http://cafebiz.vn/quan-tri.chn,http://cafebiz.vn/nghe-nghiep.chn,http://cafebiz.vn/thuong-hieu.chn,http://cafebiz.vn/welearn.chn,http://cafebiz.vn/doanh-nghiep-cong-nghe.chn".split(",");
	}
