...
public class FunyStoryCollector extends ArticleCollector {
	String[] urls = new String[] { "http://vnexpress.net/tin-tuc/cuoi"};
	public FunyStoryCollector(long repeatTime) {
		super(repeatTime);
	}
